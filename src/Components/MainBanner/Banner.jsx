...
const Banner = () => {
    return (
        <div className="ml-20 mr-20 mt-12 ">
            <div className="bg-yellow-200 flex flex-row justify-between h-[400px] rounded-xl">
                ...
                <div className=" mr-40 ">
                    ...
                    <img className="w-[280px]" src="/public/449714570_1028802128864981_7984422022768001535_n.jpg" alt="" />
                    </div>
                </div>
