    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div role="tablist" className="tabs tabs-lifted w-[1180px]">
                <input type="radio" name="my_tabs_2" role="tab" className="tab" aria-label="Read Books" checked={activeTab === 'read-books'}
                    onChange={() => setActiveTab('read-books')} />
                <div role="tabpanel" className="tab-content bg-base-100 ">
                    {ReadBooks.map(book => <Bookscomplete key={book.id} ronbi={book} ></Bookscomplete>)}

                </div>

                <input type="radio" name="my_tabs_2" role="tab" className="tab" aria-label="Wishlist Books" checked={activeTab === 'wishlist'}
